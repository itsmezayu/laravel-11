...
:: --- TERMINAL 5: FastAPI PTN (Python) ---
echo [5/6] Menjalankan API PTN (Python)...
...
start "API Flask" cmd /k "cd /d C:\laragon\www\flask-campus-track && call .\.venv\Scripts\activate && python -m app.run"
